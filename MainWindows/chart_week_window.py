...
from .combination_info_window import CombinationInfo
...
class ChartWeekWindow(Ui_MainWindow, WorkWithCombination):
    def __init__(self):
    ...
    def initUI(self):
        ...
        self.btn_add_note.clicked.connect(self.add_event)
    ...
    def parse(self):
        """Востанавливает данные заметок из БД"""
    ...
    def create_table(self):
        ...
        dialog.exec()
        # если дни не выбраны мы не создаем таблицу
        if not self.days_in_table:
            return
